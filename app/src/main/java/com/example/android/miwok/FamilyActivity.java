...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("older brother", "Anna",R.drawable.family_older_brother,R.raw.family_older_brother));
        ...
        words.add(new Word("grandfather", "Thattayya",R.drawable.family_grandfather,R.raw.family_grandfather));
